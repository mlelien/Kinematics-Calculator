...
- (void)updateForOrientation
{
    ...
    {
        self.clearButton.frame = CGRectMake(662, 700, 82, 60);
        bannerView.frame = CGRectMake(0, [[UIScreen mainScreen] bounds].size.height - kGADAdSizeFullBanner.size.height, kGADAdSizeFullBanner.size.width, kGADAdSizeFullBanner.size.height);
        
    }
    
    else //became horiztontal
    {
        self.clearButton.frame = CGRectMake(900, 330, 82, 60);

        bannerView.frame = CGRectMake(0, [[UIScreen mainScreen] bounds].size.width - kGADAdSizeFullBanner.size.height, kGADAdSizeFullBanner.size.width, kGADAdSizeFullBanner.size.height);
    }
}
